...
class Eformance_KomerciParc_Model_Payment extends Mage_Payment_Model_Method_Abstract
{

    protected $_code  = 'Eformance_KomerciParc';
    protected $_formBlockType = 'Eformance_KomerciParc/form';
    protected $_infoBlockType = 'Eformance_KomerciParc/info';
   ...
   public function getOrderPlaceRedirectUrl($orderId = 0)
	{
	   ...
	   if ($orderId != 0 && is_numeric($orderId)) {
        ...
        return Mage::getUrl('komerce/Pay/redirect', $params);
    }
